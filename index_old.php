...
?>
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div id="mainba" style="height:350px;"></div>
        ...
        <script type="text/javascript">
            ...
            $.ajax({ 
                ...
                success: function(response) {
                    ...
                    if(response.status == '200'){
                        ...
                        $('#no_leaves').html(response['data']['leaves_count']);        
          ...
          function init_echarts() {
              ...
              //   var ctx = document.getElementById("#mainb");
            ...
            if ($('#mainba').length ){
                ...
                var echartBar = echarts.init(document.getElementById('mainba'), theme);
