            ...
            <div class="title_right" style="text-align: right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group" style="float: right">
                        ...
                        <button id="add_claimC" type="button" class="btn btn-success" data-toggle="collapse"
                            data-target="#collapseExample23" aria-expanded="false" aria-controls="collapseExample"
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive" id="list_claim_table">
                            <a download="claims report" id="download_btn" style="display:none;">
                                <button class="btn btn-primary">Download/Export</button>
                            </a>
                ...
                <div style="margin-top:2em">
                    <span data-parsley-validate class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control claim_edit_require" id="edit_claimant" disabled
                                    style="width:100% !important;max-width:800px !important; border-radius:30px !important;"></select>
                            </div>
                        </div>
