                ...
                if (response.status == '200') {
                    ...
                    if (response.total_rows != 0) {
                        ...
                        $.each(response.data, function(i, v) {
                            ...
                            list_mds += '<li>   <a ' + link_lk + ' id="themodli_' + v.module_id +
                                '"  dir="' + v.module_abbrv + "-" + v.company_id + "-" + v
                                .company_name + '" class="' + set_coy_class +
                                '" >   <span class="image"><img src="../files/images/icons/' + v
                                .module_little_icon +
                                '" alt=""></span>     <span>        <span><b>' + v.module_abbrv +
                                '</b></span> </span>       <span class="message">' + v
                                .module_full_name +
                                '</span>                      </a>          </li>';
                        ...
                        $(".fst_dd").append(list_mds +
                            '<li><div class="text-center"><a href="/user/myapps"><strong>Add More Apps </strong><i class="fa fa-angle-right"></i></a></div></li>'
                        );
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <!-- <hr style="color: #ccc;"> -->
                                <ul class="navbar-nav side-menu" style="display: ;" id="main_menu">


                                    <li class="nav-item"><a href="/hrm/" class="nav-link"><i class="fa fa-home"></i>
                                            Dashboard</a></li>

                                    <li class="nav-item"><a href="employees" class="nav-link"><i
                                                class="fa fa-users"></i> Employees </a></li>

                                    <li class="nav-item"><a href="leaves" class="nav-link"><i class="fa fa-edit"></i>
                                            Leaves </a></li>

                                    <li class="nav-item"><a href="exits" class="nav-link"><i class="fa fa-user"></i>
                                            Terminations </a></li>

                                    <li class="nav-item"><a href="grievances" class="nav-link"><i
                                                class="fa fa-edit"></i> Grievances </a></li>

                                    <li class="nav-item"><a href="attendance" class="nav-link"><i
                                                class="fa fa-bell-o"></i>Attendance</a></li>

                                    <!-- <li><a href="hrm/payroll"><i class="fa fa-edit"></i> Payroll </a></li> -->


                                    <li class="nav-item"><a class="nav-link"><i class="fa fa-user"></i> HR Settings
                                        ...
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="salary_component">Employee Payment Types</a></li>
                                    ...
                                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list fst_dd" role="menu">
                                        <li class="">
                                            <a id="feed_tg" href="../feeds">
                                                <span class="image"><img src="../files/images/icons/feeds_icon.png"
                                                        alt=""></span>
                                                <span>
                                                    <span><b>Feeds</b></span>
