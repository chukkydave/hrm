            ...
            <div class="title_right" style="text-align: right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group" style="float: right">
                        ...
                        <button type="button" class="btn btn-success" id="add_employee">Add Employment Type</button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea cols="3" class="form-control col-md-7 col-xs-12"
                                            id="employment_description"></textarea>
                                    </div>
                                </div>
...
<div class="modal fade" id="modal_type" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<script src="js-files/employment_type.js"></script>
<?php
