                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="position_name">Leave
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-4">
                                        <input type="text" id="eligibility" required="required"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                        for="position_name">Allotted
                                        Leave Days<span>*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="leave-days" required="required"
                                            class="form-control col-md-7 col-xs-12 required">
                                    </div>
                                </div>
            ...
            if (response.status == '200') {
                ...
                if (response.data.length > 0) {
                    ...
                    $.each(response['data'], function(i, v) {
                        ...
                        strTable += '<td valign="top"><a href="' + base_url + 'edit_position?id=' +
