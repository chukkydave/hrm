            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="input-group" style="float: right">
                            <button type="button" class="btn btn-sm btn-primary" id="" data-toggle="modal"
                                data-target="#selectEmployees">Select Employee(s)</button>
                        </div>
                        <div class="x_content">
                            ...
                            <div class="input-group" style="float: right">
                                ...
                                <button type="button" class="btn btn-sm btn-success"
                                    id="add_schedule_btn">Create</button>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                ...
                                <!-- <div class="container">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination" id="paginationEm"></ul>
                                    </nav>
                                </div> -->
...
<script src="js-files/create_pay_schedule.js"></script>
