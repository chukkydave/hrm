                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div id="list_empo_details" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <p class="form-control col-md-7 col-xs-12" id="dpt"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <p class="form-control col-md-7 col-xs-12" id="date_of_join"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <p class="form-control col-md-7 col-xs-12" id="supervisor"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <p class="form-control col-md-7 col-xs-12" id="emp_status"></p>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="js-files/exits.js"></script>
<?php
