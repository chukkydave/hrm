            ...
            <div class="title_right" style="text-align: right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group" style="float: right">
                        ...
                        <a href="employement_type"><button type="button" class="btn btn-success"
...
<!-- modal -->
<div class="modal fade" id="modal_employment_type" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<script src="js-files/edit_employment_type.js"></script>
