<?php
include("_common/headerback.php");
?>
...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="row top_tiles">
                        ...
                        <div class="card-body">
                            <div class="tile-stats">
                                ...
                                <div class="count" id="no_employees">
                                    <i class="fa fa-spinner fa-spin fa-fw fa-1x" style="display: ; "
                                        id="load_employees"></i>
                                </div>
                                <h3>Employees</h3>
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12" style="display: none;height:50px;">
                <div class="card">
                    <div class="card-body">
                        <div class="tile-stats">
