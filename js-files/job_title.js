				...
				if (response.data.length > 0) {
					$.each(response['data'], function(i, v) {
						...
						strTable +=
							...
							'"><i  class="fa fa-pencil"  data-toggle="tooltip" data-placement="top" style="font-style: italic; font-size: 20px;" title="Edit job title"></i></a>&nbsp;&nbsp; <a class="delete_position" style="cursor: pointer;" id="pos_' +
							response['data'][i]['position_id'] +
					...
					strTable = '<tr><td colspan="2">No record found</td></tr>';
				}
