...
<div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-8 col-md-8 col-xs-8">
                                                    <input type="text" placeholder="Add Header"
                                                        ...
                                                        id="header_name">
                                                    <p class="text-danger" id="header_error"></p>
                                                    <div style="padding:10px;font-style:italic; margin-top:10px;"><input
                                                            id="desc_allow" checked="true" type="checkbox"> Uncheck to
                                                        disallow
                                                        responses</div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-2 col-xs-4" style="">
                                                    <button type="button" class="btn btn-success"
                                                        id="add_header_btn">Add</button>
                                                    <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none;"
                                                        id="add_header_loader"></i>
                        ...
                        <div class="text-danger" id="desc_error">
                        </div>
                        ...
                        <div class="col-md-9 col-sm-9 " id="proceeding_section">
                            <!-- <div class="dropdown" style="float:right;" id="menuOptions">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
									<a class="dropdown-item pointer">Report Post</a>
								</div>
							</div>

                            <div class="dropdown show" style="float:right;" id="menuOptions">
    ...
    <!-- modal -->
    <div class="modal fade" id="modal_g" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <div id="edit_form">
                        <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="incident_date">Incident
                                    Date
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="g_against">Grievance
                                    Against
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
