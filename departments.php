...
?> 
        ...
        <!-- modal -->
        <div class="modal fade" id="modal_department" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <i data-toggle="tooltip" data-placement="top" title="Add HOD" id="add_hod" class="fa fa-plus" style="float:right;"></i>
                                  ...
                                  <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                      ...
                                      <div class="form-group">
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                              ...
                                              <button type="button" class="btn btn-success" id="add_hode">Add</button>
                  ...
                  <div class="x_content">
                    <!-- <div class="col-md-12 col-sm-12 col-xs-12"> -->
                        <div class="table-responsive">
                            <i style="display: none;" id="hod_list_loader" class="fa fa-spinner fa-spin fa-fw fa-2x"></i>
