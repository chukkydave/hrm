...
?> 
                  ...
                  <div class="x_content">
                    ...
                    <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea cols="3" class="form-control col-md-7 col-xs-12" id="position_description">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <i class="fa fa-spinner fa-spin fa-fw fa-3x" style="display: none;" id="edit_pos_loader"></i>
        ...
        <!-- modal -->
        <div class="modal fade" id="modal_position_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <script type="text/javascript">
          ...
          $.ajax({
            ...
            data: { "position_id" : position_id, "company_id" : company_id},
          ...
          $.ajax({
            ...
            data: { "position_name" : position_name, "position_description" : position_description, "company_id" : company_id, "position_id" : position_id},
