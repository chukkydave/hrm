            ...
            <div class="title_right" style="text-align: right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group" style="float: right">
                        ...
                        <a href="company_branches"><button type="button" class="btn btn-success"
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="branch_description">Branch
                                    Description
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea cols="3" class="form-control col-md-7 col-xs-12" id="branch_description">
...
<!-- modal -->
<div class="modal fade" id="modal_edit_branch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<script src="js-files/edit_company_branch.js"></script>
